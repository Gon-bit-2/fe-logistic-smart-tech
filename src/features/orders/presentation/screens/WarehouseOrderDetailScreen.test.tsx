...
import WarehouseOrderDetailScreen from "./WarehouseOrderDetailScreen";
...
describe("WarehouseOrderDetailScreen", () => {
  beforeEach(() => {
  ...
  it("renders internal warehouse detail and links back to the warehouse list", () => {
    renderWithProviders(<WarehouseOrderDetailScreen orderId="21" />);
  ...
  it("allows warehouse staff to cancel a cancelable order from the internal detail page", async () => {
  ...
  it("hides the cancel action when the order is no longer cancelable", () => {
    useOrderDetailQueryMock.mockReturnValue({
      data: {
        ...sampleOrder,
        id: "21",
