export const inventoryScreenCopy = {
  ...
  emptyDescription:
    "Hệ thống chưa ghi nhận dữ liệu trung tâm phân phối nào hoặc bạn không có quyền truy cập.",
  emptyTitle: "Chưa có dữ liệu trung tâm phân phối",
  filters: "Bộ lọc",
  headings: [
    "Mã trung tâm",
    "Tên trung tâm",
  ...
  integrationPendingDescription:
    "Các tính năng sổ kho, quét mã và cảnh báo sẽ hoạt động khi hệ thống kết nối thành công với kho hàng.",
  integrationPendingTitle: "Dữ liệu tồn kho chi tiết đang chờ tích hợp",
  lowStockAlert: "Cảnh báo tồn kho thấp",
  lowStockDescription:
    "Lithium Cell Packs (Unit-82) đang xuống dưới ngưỡng cảnh báo.",
  loadingDescription: "Đang tải danh sách trung tâm phân phối từ hệ thống...",
...
export const warehouseHubScreenCopy = {
  ...
  shiftText:
    "Kho hàng đang vận hành ở công suất cao nhất. 450 kiện đã được quét trong 2 giờ gần nhất mà không phát sinh lỗi.",
  ...
  weight: "Khối lượng",
  pendingDescription:
    "Giao diện quét mã đã sẵn sàng. Danh sách kiện hàng sẽ hiển thị khi có dữ liệu từ máy quét.",
  pendingTitle: "Hệ thống đang chờ dữ liệu quét mã",
} as const;
